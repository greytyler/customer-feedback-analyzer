...
# # 🏷️ Sentiment Mapping (Fixed)
# label_map = {0: "negative", 1: "positive"}

# # 🖼️ Page Setup
# st.set_page_config(page_title="AI Feedback Analyzer", layout="wide")
# st.title("🧠 AI Customer Feedback Analyzer")
# st.markdown("<h4 style='text-align: left;'>Powered by Amazon Comprehend + SageMaker</h4>", unsafe_allow_html=True)
...
#     return label_map.get(raw[0], "unknown")
